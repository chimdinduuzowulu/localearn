      ...
      <main className="h-full overflow-y-auto">
        <div className="container grid px-6 mx-auto">
          ...
          <div className="flex flex-col flex-wrap mb-4 space-y-4 md:flex-row md:items-end md:space-x-4">
            ...
            {/* <!-- Divs are used just to display the examples. Use only the button. --> */}
            <div>
              {/* <!-- For disabled buttons ADD these classNamees: 
                  opacity-50 cursor-not-allowed

                  And REMOVE these classNamees:
          ...
          <div className="flex flex-col flex-wrap mb-8 space-y-4 md:flex-row md:items-end md:space-x-4">
            ...
            <div>
              <button
                className="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"
                aria-label="Like"
              >
                <svg
                  className="w-5 h-5"
